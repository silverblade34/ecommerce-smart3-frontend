...
const ModalOferta = ({
  ...
  const onCloseModal = () => {
    push(
      `/articulos/detalle/${producto.modelo.nIdModelo}/${producto.proximaOferta.catalogoFuturo.sCodigoCatalogo}/${producto.colorSeleccionado.nIdColor}`
    );
    onClose();
  };
  ...
  const displayPrice = isDirector
    ? producto.proximaOferta.precios.nPrecioDirector
    : isAuthenticated
      ? producto.proximaOferta.precios.nPrecioPromotor
      : producto.proximaOferta.precios.nPrecioSugerido;

  const showOriginalPrice =
    isAuthenticated && producto.proximaOferta.precios.nPrecioSugerido > 0;
  return (
              ...
              <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white p-6 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-md">
                ...
                <div className="w-full p-2">
                  ...
                  <p className="text-center text-sm text-secondary">
                    {producto.proximaOferta.mensaje}
                  </p>
                  ...
                  <div className="flex justify-center">
                    <Link
                      ...
                      href={`/articulos/detalle/${producto.modelo.nIdModelo}/${producto.proximaOferta.catalogoFuturo.sCodigoCatalogo}/${producto.colorSeleccionado.nIdColor}`}
                    >
