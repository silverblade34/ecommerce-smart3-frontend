        ...
        <div className="mt-5 relative z-[1]  flex flex-col items-start gap-1 duration-300">
          ...
          {isDirector && (
            <>
              ...
              {/* <div className="text-sm text-[#6f42c1] bg-[#2D2A26]/10 rounded-lg px-4 py-0.5">
            Precio Directora: <a className="font-bold text-medium">{priceFormat(product.precios.nPrecioDirector)}</a>
          </div> */}
            </>
          )}

        </div>
        {(product?.catalogo?.sTipoCatalogo?.toUpperCase() == "PREVENTA" && product?.catalogo?.sCodigoCatalogo == "PRECAT2025CD11") || (product?.catalogo?.sCodigoCatalogo == "PRECAB2025UC08") && (
